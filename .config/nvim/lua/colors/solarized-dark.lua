...
function M.setup()
  ...
  local highlights = {
    ...
    -- Diff
    DiffAdd = { bg = "#073642" },
    DiffChange = { bg = "#073642" },
    DiffDelete = { fg = c.red, bg = "#073642" },
    DiffText = { bg = "#0a4a5c" },
    ...
    DiagnosticVirtualTextError = { fg = c.red, bg = "#073642" },
    DiagnosticVirtualTextWarn = { fg = c.yellow, bg = "#073642" },
    DiagnosticVirtualTextInfo = { fg = c.blue, bg = "#073642" },
    DiagnosticVirtualTextHint = { fg = c.cyan, bg = "#073642" },
