-- Gruvbox Light theme for Neovim
...
M.colors = {
  ...
  -- Syntax colors (use Gruvbox faded variants for light mode)
  red = "#9d0006",
  bright_red = "#cc241d",
  orange = "#af3a03",
  yellow = "#b57614",
...
function M.setup()
  ...
  local highlights = {
    ...
    -- Diff
    DiffAdd = { bg = "#dde5b6" },
    DiffChange = { bg = "#cddfe4" },
    DiffDelete = { bg = "#e8c8c0" },
    DiffText = { bg = "#b0d0d8" },
    ...
    DiagnosticVirtualTextError = { fg = c.red, bg = "#e8c8c0" },
    DiagnosticVirtualTextWarn = { fg = c.yellow, bg = "#e6dbb0" },
    DiagnosticVirtualTextInfo = { fg = c.blue, bg = "#cddfe4" },
    DiagnosticVirtualTextHint = { fg = c.cyan, bg = "#d4e2d4" },
